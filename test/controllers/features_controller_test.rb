...
class FeaturesControllerTest < ActionController::TestCase
  ...
  test "should create feature" do
    assert_difference('Feature.count') do
      post :create, feature: { assigned_to: @feature.assigned_to, category: @feature.category, name: @feature.name }
    end
  ...
  test "should update feature" do
    patch :update, id: @feature, feature: { assigned_to: @feature.assigned_to, category: @feature.category, name: @feature.name }
    assert_redirected_to feature_path(assigns(:feature))
  end
